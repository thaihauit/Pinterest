...
class PrimaryViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor: Const.colorWhite]
        self.navigationController?.navigationBar.tintColor           = Const.colorRed
        self.navigationController?.navigationBar.barTintColor        = Const.colorBlue
